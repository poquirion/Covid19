...
def reset_colors(colorings, values_wanted, colors):
    ...
    trait["scale"] = []
    #print("VALUE WANTED IS " + str(values_wanted))
    #print("COLOR IS " + str(colors))
...
if __name__ == '__main__':
    ...
    #print("SAMPLING IS " + SAMPLING_TRAIT)
    #print("EXPOSURE IS " + EXPOSURE_TRAIT)
    #print("INPUT IS " +  args.input)
    #print("COLORS IS " + args.colors)
    #print("LAT LONG IS " + args.lat_longs)
    ...
    with open(args.colors) as fh:
        for line in fh:
            ...
            if len(fields) == 3 and fields[0] == SAMPLING_TRAIT:
                #print("ON APPEND " + fields[1] + " et " + fields[2])
    ...
    with open(args.lat_longs) as fh:
        for line in fh:
            ...
            if len(fields) == 4 and fields[0] == SAMPLING_TRAIT:
                #print("ON AJOUTE POUR fields[1]" + fields[1] + " lat " + str(fields[2]) + " et long " + str(fields[3]))
