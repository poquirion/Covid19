...
def modify(node):
    ...
    print("HERE 3 NAME ", str(node["name"]))
    print("BEFORE ",str(node["node_attrs"][EXPOSURE_TRAIT]))
    print("AFTER ",str(node["node_attrs"][SAMPLING_TRAIT]))
...
def switch_attribute(node):
    ...
    #print("************** NAME IS ",str(node["name"]))
    #print("EXPOSURE_TRAIT ", str(EXPOSURE_TRAIT))
    #print("SAMPLING_TRAIT ", str(SAMPLING_TRAIT))
    #print("exposure is ", str(exposure))
    #print("sampling is ",str(sampling))

    #print("NODE IS ",str(node["node_attrs"]))
...
if __name__ == '__main__':
    ...
    print("HERE 2 SAMPLING_TRAIT ", str(SAMPLING_TRAIT))
    print("HERE 2 EXPOSURE_TRAIT ", str(EXPOSURE_TRAIT))
